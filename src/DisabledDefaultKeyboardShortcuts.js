 ...
 * @type {[{ctrl: boolean, shift: boolean, alt: boolean, key: number},{ctrl: boolean, shift: boolean, alt: boolean, key: number},{ctrl: boolean, shift: boolean, alt: boolean, key: number},{ctrl: boolean, shift: boolean, alt: boolean, key: number}]}
 */
