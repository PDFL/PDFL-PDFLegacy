...
class ImageExtractorService extends DocumentParser{
  ...
  imageDataToCanvas(imageObject) {
    ...
    if(imageObject.kind === 2){ //Kind = 2 -> transparent
      const newImageData = this.#addAlphaChannelToUnit8ClampedArray(imageObject.data, imageObject.width, imageObject.height);
